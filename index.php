...
<div class = 'intro'>
	...
	<p class = 'warning'><strong>Attention!</strong> The Humble Visualisations have now been retired. From February 3rd onwards, no new data will be gathered. Existing data (with existing gaps) will remain <a href = 'downloads/data.sql.gz'>archived</a> and viewable, and the project sources will remain up <a href = 'https://github.com/Cheeseness/humble-visualisations'>on GitHub</a>. For more information, click the <a onclick = 'javascript: showHelper("about"); return false;'>About/History</a> tab at the bottom of the screen.</p>
...
<div id = 'help' class = 'popup'>
	...
	<p>You can also find an FAQ of sorts by clicking the <strong><a onclick = 'javascript: showHelper("footnotes"); return false;'>Footnotes</a></strong> tab above.</p>
...
<div id = 'footnotes' class = 'popup'>
	...
	<p id = 'foot4'><span class = 'footnote'>4</span>: "Separate price" values up to and including the Humble Bundle for Android 2 onwards were sourced from developer prices where available (and Steam prices where not, excluding Canabalt, for which the iTunes price was used) as at 11th of April 2012. Values for later bundles have been parsed from the humblebundle.com website. Keep in mind that some bundle titles (including tech demos, prototypes and game jam outcomes) have no price associated with them. The initial separate price value for the Humble Deep Silver Bundle was not parsed correctly, but was confirmed as being $190 by Jeff Rosen.</p>
	...
	<h2>Questions!</h2>
	<p><strong>None of the newer bundles are shown. What gives?</strong> The Humble Visualisations have been retired and are now in archive mode. From February 3rd 2016 onwards, no new data will be collected. For more information, click the <strong><a onclick = 'javascript: showHelper("about"); return false;'>About/History</a></strong> tab above.</p>
...
<div id = 'sightings' class = 'popup'>
	...
	<p>If you find something I've missed, please <a href = 'mailto:cheese@cheesetalks.net'>let me know</a>.</p>
	<h2>Cheese's Articles</h2>
	<ul>
		<li><a href = 'http://cheesetalks.net/humble_presentation/'>Cross-platform Support In Humble Bundles</a> - A browser based slideshow covering most of the topics from my third Humble Bundle stats article.</li>
		<li><a href = 'http://cheesetalks.net/humbleStats3.php'>Cheese talks to himself (about cross-platform support in Humble Bundles)</a> - My third article, this time focusing more on cross platform support and porting outcomes from Humble Bundle promotions.</li>
		<li><a href = 'http://cheesetalks.net/humbleStats2.php'>Cheese talks to himself (about Humble Bundle statistics again)</a> - Another article by myself which looks at the Humble Music Bundle as a "control sample" for understanding the statistics of other bundles.</li>
		<li><a href = 'http://cheesetalks.net/humbleStats.php'>Cheese talks to himself and others (about Humble Bundle statistics)</a> - An article by myself which has a bunch of additional graphs with information from additional sources and some quotes/comments from top Humble Bundle contributors.</li>
	</ul>
</div>
<div id = 'about' class = 'popup'>
	<h2>Wait, "Retired"? Why?</h2>
	<p>It's been a difficult decision to make, but has been something that's been on my mind for some time. Humble has moved beyond the philosphies and principles that originally inspired and motivated me to start aggregating data. My enthusiasm has been sapped and my passion is gone. I no longer receive notifications of markup changes, so the parser often breaks without my knowledge. Rather than leaving the Humble Visualisations running unmaintained, it feels better to officially retire it.</p>
	...
	<p>I dabble in a lot of things, but if you're on this page, then the ones that might interest you most are my collection of "<a href = 'http://cheesetalks.net/'>Cheese Talks</a>" reviews, articles and interviews where I look at and talk to people and things relating to the gaming and the Free Software world (not necessarily at the same time), the open and closed source <a href = 'http://cheeseness.itch.io/'>games I've worked on</a>, <a href = 'https://www.patreon.com/cheeseness'>my Patreon campaign</a>, which I use to help support my writing and game development efforts, and maybe <a href = 'http://twolofbees.com'>twolofbees.com</a>, a cute art-blog-comic thing where I occasionally put fan art for games (and <a href = 'http://twolofbees.com/artwork.php?iid=959'>this vaguely relevant image</a>).</p>
	<p>I can be followed/stalked/casually observed on twitter as <a href = 'http://twitter.com/ValiantCheese'>@ValiantCheese</a>.</p>
...
<footer>
Proudly presented by Cheeseness of <a href = 'http://cheesetalks.net'>cheesetalks.net</a> and contributors.
</footer>
</body>
</html>
