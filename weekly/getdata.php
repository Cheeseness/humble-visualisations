<?php
	...
	if(isset($_GET['bundle']))
	{
		...
		else if (strcasecmp($_GET['bundle'], "arcen") == 0)
		{
			$bundleTitle = "The Humble Weekly Sale: Arcen Games";
		}
		else if (strcasecmp($_GET['bundle'], "retro") == 0)
		{
		...
		else if (strcasecmp($_GET['bundle'], "kalypso") == 0)
		{
			$bundleTitle = "Humble Weekly Sale: Kalypso Media";
		}
		else if (strcasecmp($_GET['bundle'], "Nordic") == 0)
		{
			$bundleTitle = "The Humble Weekly Sale: Nordic Games";
		}
		else if (strcasecmp($_GET['bundle'], "Focus") == 0)
		{
			$bundleTitle = "The Humble Weekly Sale: Focus Home Interactive";
		}
		else if (strcasecmp($_GET['bundle'], "hothead") == 0)
		{
			$bundleTitle = "The Humble Weekly Sale: Hothead Games";
		}
		else if (strcasecmp($_GET['bundle'], "cipher") == 0)
		{
			$bundleTitle = "The Humble Weekly Sale: Cipher Prime";
		}
		else if (strcasecmp($_GET['bundle'], "team 17") == 0)
		{
			$bundleTitle = "The Humble Weekly Sale: Team 17";
		}
		else if (strcasecmp($_GET['bundle'], "daedalic") == 0)
		{
